...
exports.up = function (knex) {
  return knex.schema
    .createTable("projects", (projects) => {
      ...
      projects.string("project_name", 100).unique().notNullable();
    ...
    .createTable("characters", (char) => {
      ...
      char.string("character_name", 100).unique().notNullable();
    ...
    .createTable("scenes", (scenes) => {
      ...
      scenes.string("scene_name", 100).unique().notNullable();
      scenes.float("scene_number").notNullable();
