      ...
      return knex("stories").insert([
        {
          ...
          story_summary:
            "Luke Skywalker gains two droids and a set of plans to the Death Star. He meets many other characters and an understanding of the force.",
          story_notes:
            "Need more plans for the other characters. The summary should include them",
          project_id: 1,
        },
        {
          ...
          story_summary:
            "The Rebel Alliance is attacked on Hoth and escape broken. Leia, Han, Chewy, and C3PO are chased by the empire while Luke goes with R2D2 to Degoba to train.",
