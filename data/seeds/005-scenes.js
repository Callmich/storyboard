  ...
  .then(function (){
    return knex('scenes').insert([
      ...
      },
      {
        ...
        scene_number: 1,
        scene_summary: "A scrolling screen explaining what has happened since episode iv. It sets the stage for the rebels to be on Hoth and the Empire & vader searching for them.",
      ...
      },
      {
        ...
        scene_number: 2,
        scene_summary: "A star destroyer sends out probes. One crashes on the ice planet Hoth. Luke calls Han on the radio. They have finished work and Luke is going to check out the meteor impact. He is then attacked by a large beast and knocked out.",
        scene_notes: null,
        story_id: 2,
        scene_timespan: "Could be weeks between probes launching and scene on Hoth"
      },
      {
        // For ref will be id 8
        scene_name: "The Rebel Base",
        scene_number: 3,
        scene_summary: "Han arrives back at Echo base. Chewie is working on the Falcon which is having issues. Han advises a general the job was done and learns Luke has not yet arrived. He says he needs to leave to pay off a debt and coly says goodby to Leia. She follows him and they argue. Han tries to get Leia to confess she has feelings for him.",
        scene_notes: null,
        story_id: 2,
      ...
      },
      {
        ...
        scene_number: 5,
        scene_summary: "Luke awakes in the Wampa's cave with his feet frozen to the ceiling. He is trapped. He uses the force to get his lightsaber - frees himself and attacks the beast. He then collapses in the cold. Han is out searching but it is getting darker, windier, and colder.",
      ...
      },
      {
        ...
        scene_number: 2,
        scene_summary: "Later, everyone meets up in Group Study Room F but they immediately notice Britta isn't there. She then emerges from her hiding place and tells the group she's trying to avoid the gossip mongers of the school after her embarrassing declaration at the Dance.",
        scene_notes: "Summary taken from community-sitcom.fandom.com",
        story_id: 4,
        scene_timespan: null
      },
      ...
      },
      {
        ...
        scene_number: 1,
        scene_summary: "The study group is in the cafeteria when Dean Pelton shows up and tells them about the upcoming Pop and Locktober Fest dance contest. While everyone else is excited about competing, Jeff is annoyed and leaves accompanied by Abed.",
        scene_notes: "Summary taken from community-sitcom.fandom.com",
        story_id: 5,
        scene_timespan: null
      },
      ...
      },
      {
        ...
        scene_name: "Hallway to class",
        scene_number: 2,
        scene_summary: "On their way to the Anthropology classroom, the study group implores Jeff to talk to Pierce. Jeff tells them that they should just respect his religion and let him grieve in his own way. After entering the classroom, they meet up with Pierce and try to do as Jeff says.",
        scene_notes: "Summary taken from community-sitcom.fandom.com",
        story_id: 6,
        scene_timespan: null
      },
      ...
      },
      {
        ...
        scene_number: 4,
        scene_summary: "R2 and 3P0 find Han and Chewie to check if Luke has arrived. Han goes accross the base to find him and finds out no one has seen him. Han leaves into the cold wild to find Luke and is advised his taun-taun will die in the cold out there.",
        scene_notes: "It is important for Han's concern to grow and climax into his leaving.",
        story_id: 2,
