  ...
  StoryCharacter.find()
    ...
    .catch((error) => {
      res
        .status(500)
        .json({
          message: `failed to get story_characters from server ${error}`,
        });
    });
});
    ...
    .then((storyChar) => {
      if (storyChar) {
        ...
        res
          .status(404)
          .json({
            message: `Could not find an entry with story_character_id ${id}`,
          });
      }
    })
    .catch((error) => {
  ...
  SharedFunc.findById("stories", id)
        ...
        StoryCharacter.findByStoryId(id)
          ...
          .catch((error) => {
            res
              .status(500)
              .json({
                message: `Failed to get story_characters by story id - Error: ${error}`,
              });
          });
      } else {
    ...
    .catch((error) => {
      res
        .status(500)
        .json({
          message: `Failed to get story_characters by project id - Error: ${error}`,
        });
    });
});
  ...
  SharedFunc.findById("characters", id)
        ...
        StoryCharacter.findByCharacterId(id)
          ...
          .catch((error) => {
            res
              .status(500)
              .json({
                message: `Failed to get story_characters by character id - Error: ${error}`,
              });
          });
      } else {
        res
    ...
    .catch((error) => {
      res
        .status(500)
        .json({
          message: `Failed to get story_characters by story - Error: ${error}`,
        });
    });
});
  ...
  SharedFunc.add("story_characters", storyCharData)
    ...
    .catch((error) => {
      res
        .status(500)
        .json({
          message: `Failed to create link for Story and Character - Error: ${error}`,
        });
    });
});
        ...
        SharedFunc.update("story_characters", id, changes)
          ...
          .catch((error) => {
            res
              .status(500)
              .json({
                message: `Error updating the story_Characters connection with server Error: ${error}`,
              });
          });
      } else {
        res
          .status(404)
          .json({
            message: `Could not find connection between character and Story`,
          });
      }
    })
    .catch((error) => {
      res
        .status(500)
        .json({
          error: `Failed to update story_characters connection ${error}`,
        });
    });
});
  ...
  SharedFunc.remove("story_characters", id)
    .then((deleted) => {
      if (deleted) {
        ...
        res
          .status(404)
          .json({ error: `Could not find story_characters with id ${id}` });
      }
    })
    .catch((error) => {
      res
        .status(500)
        .json({
          error: `Server unable to delete story_character - Error: ${error}`,
        });
    });
});
